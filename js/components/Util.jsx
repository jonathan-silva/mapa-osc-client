  ...
  var FormItem = React.createClass({
    renderListItems: function(){
      ...
      if(this.props.header){
        ...
        items.push(<HeaderElement>{this.props.header.text}<a classname='btn-item ajuda' type='button' title={'Clique para informações sobre os campos de ' + this.props.header.text} onclick='abrirModalAjuda({this.props.header.text});'><span classname='glyphicon glyphicon-question-sign' aria-hidden='true'></span></a></HeaderElement>);
      }
      for (var i=0; i<this.props.dados.length; i++){
