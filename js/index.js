require(["nv.d3.lib"], function (React) {
  ...
  function dashboard(id, fData){
      ...
      function segColor(c){ return {col1:"#66ccea", col2:"#d9534f",col3:"#ffd82f"}[c]; }

      // compute total for each state.
      fData.forEach(function(d){d.total=d.freq.col1+d.freq.col2+d.freq.col3;});
      ...
      var tF = ['col1','col2','col3'].map(function(d){
  ...
  var freqData=[
  {State:'Sudeste',freq:{col1:207238, col2:19795, col3:1078527}}
  ,{State:'Sul',freq:{col1:48909, col2:5492, col3:338729}}
  ,{State:'Centro-Oeste',freq:{col1:19042, col2:2077, col3:117312}}
  ,{State:'Norte',freq:{col1:7338, col2:1935, col3:58064}}
  ,{State:'Nordeste',freq:{col1:47994, col2:6322, col3:245275}}
  ];
